...
{"besseln",0,(void*)nbessel,8,"GGp","besseln(nu,x): deprecated alias for bessely."},
{"bessely",0,(void*)nbessel,8,"GGp","bessely(nu,x): Y-bessel function of index nu and argument x."},
...
{"dirpowerssum",0,(void*)dirpowerssum0,5,"GGp","dirpowerssum(n,x): return 1^x + 2^x + ... + n^x."},
...
{"sqrtint",0,(void*)sqrtint0,5,"GD&","sqrtint(x,{&r}): integer square root y of x, where x is a nonnegative integer. If r is present, set it to the remainder x - y^2."},
