      ...
      {"nlp_feasibilitytolerance",0,    _NLP_FEAS_TOL, _INT_MAPLECONVERSION,T_TYPE_ID},
      ...
      {"nlp_integertolerance",0,    _NLP_INT_TOL, _INT_MAPLECONVERSION,T_TYPE_ID},
      ...
      {"nlp_samples",0,    _NLP_SAMPLES, _INT_MAPLECONVERSION,T_TYPE_ID},
