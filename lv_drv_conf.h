...
#  if EVDEV_CALIBRATE
#    define EVDEV_HOR_MIN       411               /*to invert axis swap EVDEV_XXX_MIN by EVDEV_XXX_MAX*/
#    define EVDEV_HOR_MAX      3935               /*"evtest" Linux tool can help to get the correct calibraion values>*/
#    define EVDEV_VER_MIN       237
#    define EVDEV_VER_MAX      3820
